...
<tr><td class="middletext"><img src="2.jpg<?php echo $data[5];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="3.jpg<?php echo $data[6];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="t8.jpg<?php echo $data[7];?>" width="200px" height="200px"  /></td>
</tr>
