	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>To fill the earth with the light and warmth of hospitality by delivering exceptional experiences to every guest, every time.</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>To provide our clients with the best possible travel experience by creating custom itineraries and using our intimate knowledge of destinations around the world</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>Establish guidelines for the number of tourists per staff member who serves as a guide on each tour.</p>
		 </div>
	 </div>
</div>
<!--/About-->
